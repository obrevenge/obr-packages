...
pacman -Syy | tee .pacmanstatus.txt | zenity --progress --title="Revenge Software Tool" --no-cancel --pulsate --text "Updating Package Database..." --width=500 --auto-close
...
# Installing packages
pacman -S --noconfirm $packages | zenity --progress --title="Revenge Software Tool" --no-cancel --pulsate --text "Installing Packages..." --width=500 --auto-close
